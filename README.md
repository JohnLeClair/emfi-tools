...
## Overview
This is a basic console-based application xy_stage.py (and supporting files) to control 3D-Printer to perform XY scans on various selectable CPU architectures I am working with. It is really rough python code but at least it useable.
